...
# Feature
# RUN mvn com.dkirrane.maven.plugins:ggitflow-maven-plugin:${GITFLOW_VERSION}:feature-start -DfeatureName=FEATURE-1 -DpushFeatureBranch=true
# RUN mvn com.dkirrane.maven.plugins:ggitflow-maven-plugin:${GITFLOW_VERSION}:feature-finish -DfeatureName=FEATURE-1 -DpushFeatureFinish=true
